---
task_id: 20260715T010948875438Z-unattended-governance-upgrade
project: multi-cli-workflow-lab
status: automated_gates_passed
observed_at: 2026-07-15T01:11:18.390176+00:00
route: high
---
...
- Version: `0.1.28` → `0.1.29` on success
...
- Changed files: CHANGELOG.md, README.md, docs/public-release-topology.md, knowledge/Tasks/multi-cli-workflow-lab/20260715T010948875438Z-unattended-governance-upgrade.md, knowledge/Topics/Languages/javascript.md, knowledge/Topics/Languages/python.md, knowledge/Topics/Languages/shell.md, reports/governance-recovery-v0.13.2.md, reports/unattended-knowledge-audit.json, templates/github/public-ci.yml, templates/github/public-oracle.yml, templates/github/sage-public-merge-policy.json, tests/test_public_export.py, tools/public_export.py, tools/verify_public_export.py, workflow/public_export.py
- Failing checks: none
